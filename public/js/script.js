(function($) {
	...
	$(".menu-btn").on("click", function() {
		...
		console.log("Body active class:", $("body").hasClass("active"));
		console.log("Menu button active class:", $(this).hasClass("active"));
		return false;
	});
...
/* ==========================================================================
   ...
   ========================================================================== */
	...
	$(".cart-btn").on("click", function() {
		...
		// Disabled overlay to prevent shadow effect
...
// Auto-popup functionality disabled to prevent unwanted overlay
// $(window).on("load", function(){
...
// Additional safety measures to prevent overlay issues
$(document).ready(function() {
    // Remove any existing overlay classes on page load
    $('.page-wrapper').removeClass('overlay page-overlay overlay-remove');
    
    // Ensure no popups are active on page load
    $('.popup-quick-view, .subscribe-popup').removeClass('active remove remove-popup');
    
    // Hide any visible loading elements
    $('.loading').hide();
    
    // Prevent any automatic popup activation
    $(document).off('click.popup-trigger');
    

    
    console.log('Enhanced safety measures applied - overlays cleared');
});
