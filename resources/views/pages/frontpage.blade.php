...
<!-- Mirrored from glance-html.foxthemes.me/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Aug 2025 00:17:47 GMT -->
<head>
<meta charset="utf-8">
...
<div class="page-wrapper home1">
        ...
        <div class="cart-body">
            ...
            <ul class="cart-sidebar-products">
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="images/resource/cr1.jpg" alt="" />
                        </div>
                ...
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="images/resource/cr2.jpg" alt="" />
                        </div>
                        <div class="card-product-thumb-info">
                            <a href="#" title="" class="close-cart-product">
                                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="images/resource/cr3.jpg" alt="" />
                        </div>
                        <div class="card-product-thumb-info">
                            <a href="#" title="" class="close-cart-product">
                                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="images/resource/cr4.jpg" alt="" />
                        </div>
                        <div class="card-product-thumb-info">
                            <a href="#" title="" class="close-cart-product">
                                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div  class="popup coming-soon-popup">
        <a href="#" title="" class="close-popup">
            <img src="images/close2.png" alt="" />
        </a>
        <div class="row">
            <div class="col-lg-6 image-popup">
                <img src="images/resource/p-img2.jpg" alt="" />
            </div>
            <div class="col-lg-6 popup-content">
                <div class="inner-column">
                    ...
                    <div class="full-btn">
                        <a href="shop-category.html" title="" class="theme-btn v2">buy now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="glance-banner">
        <div class="video-intro wow fadeInUp">
            <video id="video1" controls autoplay="autoplay" loop>
                <source src="1105931_1080p_Teenage_Hood_1920x1080.mp4"/>
            </video>
        </div>
    </section>   
                        ...
                        <div class="circle-container">
                         ...
                         <div class="cart-product-slider-slide">
                            <div class="cart-product-slide">
                                <img src="images/resource/product1.png" alt="" />
                            </div>
                            <div class="cart-product-slide">
                                <img src="images/resource/product2.png" alt="" />
                            </div>
                            <div class="cart-product-slide">
                                <img src="images/resource/product3.png" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="cart-slider-thumb wow slideInLeft">
                        <div class="cart-product-thumb-slide">
                            <img src="images/resource/product2.jpg" alt="" />
                        </div>
                        <div class="cart-product-thumb-slide">
                            <img src="images/resource/product-2.jpg" alt="" />
                        </div>
                        <div class="cart-product-thumb-slide">
                            <img src="images/resource/product-3.jpg" alt="" />
                        </div>
                    </div>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'974f21e22bb50b09',t:'MTc1NjE2NzMwMQ=='};var a=document.createElement('script');a.src='cdn-cgi/challenge-platform/h/b/scripts/jsd/4710d66e8fda/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>

<!-- Mirrored from glance-html.foxthemes.me/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Aug 2025 00:18:30 GMT -->
</html>
