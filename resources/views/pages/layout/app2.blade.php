        ...
        <div class="container">
            <div class="header-content">
                ...
                <ul class="menu-other-links">
                    ...
                    <li>
                        <a href="#" title=""><img src="{{ asset('images/user.svg') }}" alt="" /></a>
                    </li>
                </ul>
                <div class="menu">
                    <div class="menu-btn">
    ...
    <div class="overlay-menu">
        <ul class="menu-links">
            ...
            <li>
                <a href="#" title="">shop</a>
                <ul>
                    <li><a href="{{ route('shop') }}" title="">Shop Category</a></li>
                    <li><a href="#" title="">Shop Single</a></li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="#" title="">Blog Single</a></li>
                </ul>
            </li>
            <li>
        ...
        <div class="cart-body">
            ...
            <ul class="cart-sidebar-products">
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="{{ asset('images/resource/cr1.jpg') }}" alt="" />
                        </div>
                ...
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="{{ asset('images/resource/cr2.jpg') }}" alt="" />
                        </div>
                        <div class="card-product-thumb-info">
                            <a href="#" title="" class="close-cart-product">
                                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="{{ asset('images/resource/cr3.jpg') }}" alt="" />
                        </div>
                        <div class="card-product-thumb-info">
                            <a href="#" title="" class="close-cart-product">
                                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <div class="cart-product-column">
                        <div class="card-product-thumb-sd">
                            <img src="{{ asset('images/resource/cr4.jpg') }}" alt="" />
                        </div>
                        <div class="card-product-thumb-info">
                            <a href="#" title="" class="close-cart-product">
                                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="circle-container">
                         ...
                         <div class="cart-product-slider-slide">
                            <div class="cart-product-slide">
                                <img src="{{ asset('images/resource/product1.png') }}" alt="" />
                            </div>
                            <div class="cart-product-slide">
                                <img src="{{ asset('images/resource/product2.png') }}" alt="" />
                            </div>
                            <div class="cart-product-slide">
                                <img src="{{ asset('images/resource/product3.png') }}" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="cart-slider-thumb wow slideInLeft">
                        <div class="cart-product-thumb-slide">
                            <img src="{{ asset('images/resource/product2.jpg') }}" alt="" />
                        </div>
                        <div class="cart-product-thumb-slide">
                            <img src="{{ asset('images/resource/product-2.jpg') }}" alt="" />
                        </div>
                        <div class="cart-product-thumb-slide">
                            <img src="{{ asset('images/resource/product-3.jpg') }}" alt="" />
                        </div>
                    </div>
...
<!-- Cloudflare script removed to prevent 404 errors --></body>
